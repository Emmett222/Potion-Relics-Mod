...
public class ModConfigs {
    ...
    static {
        ...
        DOLPHINS_GRACE_PARTICLES = BUILDER.comment("Show potion swirls?").define("dolphinsGraceParticles", false);
        BUILDER.pop();
        ...
        FIRE_RESISTANCE_UPGRADE = BUILDER.comment("Can upgrade in offhand").define("fireResistanceUpgrade", false);
        FIRE_RESISTANCE_PARTICLES = BUILDER.comment("Show potion swirls?").define("fireResistanceParticles", false);
        BUILDER.pop();

        // --- HASTE ---
        BUILDER.push("Haste Relic");
        HASTE_LEVEL = BUILDER.comment("Amplifier level for Haste" + levelExplanation).defineInRange("hasteLevel", 1, 0,
                254);
        ...
        INVISIBILITY_PARTICLES = BUILDER.comment("Invisibility Relic shows particles").define("invisibilityParticles",
                true);
        BUILDER.pop();
